...
export function AccessibilityWidget() {
  ...
  // Cerrar con tecla Escape (no necesitamos listener global de mousedown:
  // un backdrop transparente captura el click fuera y delega a setOpen(false))
  useEffect(() => {
    if (!open) return;
            ...
            >
              ...
              <div className="px-3 pt-3">
                <button
                  ...
                  className={cn(
                    "w-full min-h-[56px] flex items-center gap-3 text-left rounded-xl px-3 py-2.5 transition-colors border-2",
                    a11y.highContrast
                ...
                >
                  ...
                  <span className={cn(
                    "relative h-6 w-11 rounded-full transition-colors shrink-0 border-2",
                  ...
                  {SCALE_OPTIONS.map(opt => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          "relative min-h-[60px] rounded-xl border-2 flex flex-col items-center justify-center gap-0.5 transition-all",
                          active
                      ...
                      >
                        ...
                        {active && (
                          <span className="absolute top-1 right-1 size-4 rounded-full bg-indigo-600 flex items-center justify-center">
              ...
              {hasActiveSetting && (
                <div className="border-t border-slate-100 px-3 py-2.5 bg-slate-50/40">
                  <button
                    type="button"
                    onClick={a11y.reset}
                    className="w-full min-h-[36px] flex items-center justify-center gap-1.5 rounded-lg text-[12px] text-slate-700 hover:text-slate-900 hover:bg-white font-semibold transition-colors"
                  >
